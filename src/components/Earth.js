...
import ObjectsNearEarth from "./ObjectsNearEarth";
 ...
 function Earth(){
    ...
    useEffect(() => {
        ...
        axios.get('https://api.nasa.gov/neo/rest/v1/neo/browse?api_key=YT2v2f6KZQXdSMtzPMrdu27ojErRY7iIsKHjn1KK')
        .then((response)=>{
...
const eachObject = data.map((object,index)=>{
    return (<div key={index}> <ObjectsNearEarth object={object}/> </div>)
        })
